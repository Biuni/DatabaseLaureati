...
class PHPMailer
{
    ...
    /**
     * Metodo customizzato per l'invio
     * dell'email di avvenuta registrazione
     * da parte di un'azienda
     * @author     Gianluca Bonifazi
     * @category   config 
     * @copyright  STI Uniurb (c) 2017
     */
    public static function sendMail($value,$username,$password){
        ...
        $mail->AltBody = 'Una nuova azienda si è iscritta al Database Laureati. | Le informazioni immesse sono: Ragione_Sociale-> '.$ragionesociale.', Nome_Referente-> '.$nomereferente.', Cognome_Referente-> '.$cognomereferente.', Email_Referente-> '.$emailreferente.', Newsletter-> '.$newsletter.'| I dati di accesso sono: Username-> '.$username.', Password-> '.$password;
